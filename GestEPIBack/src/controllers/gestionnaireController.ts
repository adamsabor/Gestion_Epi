// ************************************************************************
// 🎓 CONTRÔLEUR DES GESTIONNAIRES - PROJET GESTEPI 
...
// On importe le modèle qui gère les requêtes SQL pour les gestionnaires
...
export class GestionnaireController {
  ...
  // 📥 MÉTHODE PRINCIPALE : RÉCUPÉRATION DES GESTIONNAIRES
  ...
  getAll = async (req: Request, res: Response): Promise<void> => {
    try {
      // On appelle la méthode du modèle qui exécute : SELECT * FROM gestionnaires
...
// Ce contrôleur est responsable de la gestion des gestionnaires dans l'application.
